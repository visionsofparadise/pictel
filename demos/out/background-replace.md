...
| Before | After |
| --- | --- |
| ![](https://pictel-demos.s3.us-east-1.amazonaws.com/sources/portrait-with-background-2.jpg) | ![](https://pictel-demos.s3.us-east-1.amazonaws.com/outputs/background-replace.png) |
