...
The word LUXE rendered as gold-foil-stamped on a dark, slightly-textured background — the letters carry a vertically-varying metallic gradient that shifts through pale champagne, warm amber, and deep antique gold, suggesting reflected light and the slight rounding of foil pressed into paper. A soft offset shadow gives the letters lift off the surface. The look is the embossed gold-foil treatment on a hardcover book or a premium cosmetics package.

![](https://pictel-demos.s3.us-east-1.amazonaws.com/outputs/gold-foil-text.png)
